...
let bookCover = {
   harryPotter: {
      img: 'pic/harry-botter.jpg'
   },
   gameOfThrones: {
      img: 'pic/game-of-thrones.jpg'
   },
   MeBeforeYou: {
      img: 'pic/me-before-you.jpg'
   },
   aQuitePlace: {
      img: 'pic/a-quite-place.jpg'
   },
   theLord: {
      img: 'pic/the-lord.jpg'
   },
   theMarchine: {
      img: 'pic/the-marchine.jpg'
   },
   oliverTwist: {
      img: 'pic/oliver-twist.jpg'
   },
   kipps: {
      img: 'pic/kipps.jpg'
   },
   nooneLikeMe: {
      img: 'pic/moon-like-me.jpg'
   },
   iamZlatan: {
      img: 'pic/iam-zlatan.jpg'
   }
}
...
let bookCoverShow = (bookCover) => {
   for (let prop in bookCover) {
      ...
      picSet.appendChild(picList)

   }
}
bookCoverShow(bookCover)
let isVisible = false;
let cleanUp = document.getElementById("my-books-description")
let removeBooksInfo = () => {
   cleanUp.innerHTML = '';

}

let show = document.getElementById("show-on-click");
